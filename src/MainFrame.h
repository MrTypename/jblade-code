...
private:
        ////////////new code DM////////////////
        QList <void *> m_oaBEMWings;
        QList <void *> m_oa360Polar;
        QComboBox *m_pctrlBEMWing, *m_pctrlBEM360Polars, *m_pctrlBEMPolars, *m_pctrlBEMFoils, *m_pctrlBEMSim, *m_pctrlBEMPoint, *m_pctrlTurbine, *m_pctrlTurbineSim, *m_pctrlTurbinePoint ;
        QToolBar *m_pctrlBEMToolBar, *m_pctrlBEM360ToolBar, *m_pctrlTurbineToolBar;
        QCheckBox *m_pctrlHideWidgets, *m_pctrlHideWidgets2, *m_pctrlHideWidgets3;
        QToolButton *m_pctrlGraphView, *m_pctrl3DView, *m_pctrlPowerView, *m_pctrlPowerView2,  *m_pctrlCharView, *m_pctrlGraphView2, *m_pctrl3DView2, *m_pctrlCharView2, *m_pctrlPowerView3, *m_pctrlGraphView3, *m_pctrl3DView3, *m_pctrlCharView3;
        QAction *GraphViewAct, *ThreeDViewAct, *CharViewAct, *PowerViewAct;
        QAction *RotorGraphAct, *BladeGraphAct, *ShowAllRotorCurvesAct, *HideAllRotorCurvesAct, *IsolateCurrentBladeCurveAct, *CompareCurrentBladeCurveAct;
        QAction *EditCurrentBladeAct, *EditCurrentTurbineAct, *BEMGraphDlg, *AboutBEMAct, *LightOptionsAct;
        QAction *AboutJBLADEAct;
        QAction *DeleteCurrentBladeAct, *DeleteCurrent360PolarAct, *DeleteCurrentTurbineAct, *DeleteCurrentRotorSimAct, *DeleteCurrentTurbineSimAct, *ExportBladeGeomAct, *LoadCylindricFoilAct, *Edit360PolarAct;
        QMenu *BEMCtxMenu, *BEMViewMenu, *BEMBladeMenu, *BEM360PolarMenu, *BEMTurbine, *currentBladeMenu, *currentTurbineMenu, *current360PolarMenu, *currentBEMGraphMenu, *AboutBEMMenu;
        /////////////end new code DM////////////
...
public:
	...
	bool m_bAlphaChannel;
        ...
        ///////////////////////////new code DM////////////////////
        QAction *OnBEMAct;
        QDockWidget *m_pctrlBEMWidget, *m_pctrlSimuWidget;
