	...
	: QMainWindow(parent, flags)
{
	...
	setWindowTitle(m_VersionName);
        setWindowIcon(QIcon(":/images/JBLADE_60.jpg"));
...
// first line
	...
	m_pctrlStabViewWidget->hide();
        ////////////////////new code DM/////////////////////
        m_pctrlBEMToolBar->hide();
        m_pctrlBEM360ToolBar->hide();
        m_pctrlTurbineToolBar->hide();
        m_PowerUnit = 1;
        m_WtoUnit = 1.0;
...
////////////new code JM//////////////
void MainFrame::AboutJBLADE1()
{
        QBEM *pBEM = (QBEM *) m_pBEM;
        AboutJBLADE dlg(pBEM);
        dlg.exec();
}
/////////////end new code JM/////////
...
void MainFrame::CreateActions()
{
	...
	CreateMiarexActions();
        ...
        ////////////////////////new code DM///////////////////////////////
        OnBEMAct = new QAction(tr("&Rotor and Propeller Design"), this);
        OnBEMAct->setShortcut(tr("Ctrl+4"));
        OnBEMAct->setStatusTip(tr("Rotor and Propeller Design"));
        connect(OnBEMAct, SIGNAL(triggered()), this, SLOT(OnBEM()));

        AboutJBLADEAct = new QAction(tr("&About JBlade"), this);
        AboutJBLADEAct->setStatusTip(tr("More information about JBlade"));
        connect(AboutJBLADEAct, SIGNAL(triggered()), this, SLOT(AboutJBLADE1()));
...
void MainFrame::CreateDockWindows()
{
	...
	m_pGLWidget = new GLWidget(this);
        ...
        ////////////////////////////////////////new code DM//////////////////////////////////
        CBlade::s_pMainFrame = this;

        m_pctrlBEMWidget = new QDockWidget("BEM", this);
        m_pctrlBEMWidget->setAllowedAreas(Qt::LeftDockWidgetArea | Qt::RightDockWidgetArea);
        addDockWidget(Qt::LeftDockWidgetArea, m_pctrlBEMWidget);

        m_pctrlSimuWidget = new QDockWidget("Simulation Parameters", this);
        m_pctrlSimuWidget->setAllowedAreas(Qt::RightDockWidgetArea | Qt::LeftDockWidgetArea);
        addDockWidget(Qt::RightDockWidgetArea, m_pctrlSimuWidget);

        m_pBEM = new QBEM(this);
        QBEM *pBEM = (QBEM*)m_pBEM;
        pBEM->setAttribute(Qt::WA_DeleteOnClose, false);
        m_pctrlBEMWidget->setWidget(pBEM);
        m_pctrlBEMWidget->setVisible(false);

        m_pSimuWidget = new SimuWidget(this);
        SimuWidget *pSimuWidget = (SimuWidget *) m_pSimuWidget;
        pSimuWidget->setAttribute(Qt::WA_DeleteOnClose, false);
        m_pctrlSimuWidget->setWidget(pSimuWidget);
        m_pctrlSimuWidget->setVisible(false);

        m_p2DWidget->m_pBEM = pBEM;

        pSimuWidget->m_pBEM = pBEM;

        pBEM->s_pMainFrame = this;
        pBEM->s_poaFoil   = &m_oaFoil;
        pBEM->s_poaPolar   = &m_oaPolar;
        pBEM->s_poaBEMWings = &m_oaBEMWings;
        pBEM->s_poa360Polar = &m_oa360Polar;
        pBEM->m_pGLWidget = m_pGLWidget;
        pBEM->m_p2DWidget = m_p2DWidget;
        pBEM->m_pSimuWidget = pSimuWidget;

        BData::s_poa360Polar = &m_oa360Polar;
...
// Create common File, View and Help menus
	...
	fileMenu->addAction(OnXDirectAct);
        ...
        /////////////////////new code DM///////////////////////
        fileMenu->addAction(OnBEMAct);
        CreateBEMMenus();
        CBlade::s_pMiarex = m_pMiarex;
        ////////////////////end new code DM////////////////
//	fileMenu->addAction(OnMiarexAct);
   ...
   // helpMenu->addAction(guidelinesAct);
    helpMenu->addAction(AboutJBLADEAct);
...
void MainFrame::CreateBEMToolbar()
{
        ...
        m_pctrl3DView->setDefaultAction(ThreeDViewAct);
        m_pctrl3DView->setCheckable(true);
        m_pctrlGraphView = new QToolButton;
        m_pctrlGraphView->setDefaultAction(GraphViewAct);
        m_pctrlGraphView->setCheckable(true);
        m_pctrlCharView = new QToolButton;
        m_pctrlCharView->setDefaultAction(CharViewAct);
        m_pctrlCharView->setCheckable(true);
        m_pctrlPowerView = new QToolButton;
        m_pctrlPowerView->setDefaultAction(PowerViewAct);
        m_pctrlPowerView->setCheckable(true);


        m_pctrl3DView2 = new QToolButton;
        m_pctrl3DView2->setDefaultAction(ThreeDViewAct);
        m_pctrl3DView2->setCheckable(true);
        m_pctrlGraphView2 = new QToolButton;
        m_pctrlGraphView2->setDefaultAction(GraphViewAct);
        m_pctrlGraphView2->setCheckable(true);
        m_pctrlCharView2 = new QToolButton;
        m_pctrlCharView2->setDefaultAction(CharViewAct);
        m_pctrlCharView2->setCheckable(true);
        m_pctrlPowerView2 = new QToolButton;
        m_pctrlPowerView2->setDefaultAction(PowerViewAct);
        m_pctrlPowerView2->setCheckable(true);

        m_pctrl3DView3 = new QToolButton;
        m_pctrl3DView3->setDefaultAction(ThreeDViewAct);
        m_pctrl3DView3->setCheckable(true);
        m_pctrlGraphView3 = new QToolButton;
        m_pctrlGraphView3->setDefaultAction(GraphViewAct);
        m_pctrlGraphView3->setCheckable(true);
        m_pctrlCharView3 = new QToolButton;
        m_pctrlCharView3->setDefaultAction(CharViewAct);
        m_pctrlCharView3->setCheckable(true);
        m_pctrlPowerView3 = new QToolButton;
        m_pctrlPowerView3->setDefaultAction(PowerViewAct);
        m_pctrlPowerView3->setCheckable(true);


        m_pctrlBEMWing    = new QComboBox();
        m_pctrlBEMWing->setSizeAdjustPolicy(QComboBox::AdjustToContents);
        m_pctrlBEMWing->setMinimumWidth(170);
        m_pctrlBEMWing->setEnabled(false);

        m_pctrlBEM360Polars = new QComboBox();
        m_pctrlBEM360Polars->setSizeAdjustPolicy(QComboBox::AdjustToContents);
        m_pctrlBEM360Polars->setMinimumWidth(170);
        m_pctrlBEM360Polars->setEnabled(false);

        m_pctrlBEMPolars = new QComboBox();
        m_pctrlBEMPolars->setSizeAdjustPolicy(QComboBox::AdjustToContents);
        m_pctrlBEMPolars->setMinimumWidth(170);
        m_pctrlBEMPolars->setEnabled(false);

        m_pctrlBEMFoils = new QComboBox();
        m_pctrlBEMFoils->setSizeAdjustPolicy(QComboBox::AdjustToContents);
        m_pctrlBEMFoils->setMinimumWidth(170);
        m_pctrlBEMFoils->setEnabled(false);

        m_pctrlBEMSim = new QComboBox();
        m_pctrlBEMSim->setSizeAdjustPolicy(QComboBox::AdjustToContents);
        m_pctrlBEMSim->setMinimumWidth(170);
        m_pctrlBEMSim->setEnabled(false);

        m_pctrlBEMPoint = new QComboBox();
        m_pctrlBEMPoint->setSizeAdjustPolicy(QComboBox::AdjustToContents);
        m_pctrlBEMPoint->setMinimumWidth(170);
        m_pctrlBEMPoint->setEnabled(false);

        m_pctrlTurbine = new QComboBox();
        m_pctrlTurbine->setSizeAdjustPolicy(QComboBox::AdjustToContents);
        m_pctrlTurbine->setMinimumWidth(170);
        m_pctrlTurbine->setEnabled(false);

        m_pctrlTurbineSim = new QComboBox();
        m_pctrlTurbineSim->setSizeAdjustPolicy(QComboBox::AdjustToContents);
        m_pctrlTurbineSim->setMinimumWidth(170);
        m_pctrlTurbineSim->setEnabled(false);

        m_pctrlTurbinePoint = new QComboBox();
        m_pctrlTurbinePoint->setSizeAdjustPolicy(QComboBox::AdjustToContents);
        m_pctrlTurbinePoint->setMinimumWidth(170);
        m_pctrlTurbinePoint->setEnabled(false);

        m_pctrlHideWidgets = new QCheckBox(tr("Hide Widgets"));
        m_pctrlHideWidgets->setChecked(false);
        m_pctrlHideWidgets2 = new QCheckBox(tr("Hide Widgets"));
        m_pctrlHideWidgets2->setChecked(false);
        m_pctrlHideWidgets3 = new QCheckBox(tr("Hide Widgets"));
        m_pctrlHideWidgets3->setChecked(false);



        m_pctrlBEMToolBar = addToolBar(tr("BEM"));
        m_pctrlBEMToolBar->addAction(newProjectAct);
        m_pctrlBEMToolBar->addAction(openAct);
        m_pctrlBEMToolBar->addAction(saveAct);
        m_pctrlBEMToolBar->addSeparator();
        m_pctrlBEMToolBar->addWidget(m_pctrlGraphView);
        m_pctrlBEMToolBar->addWidget(m_pctrl3DView);
        m_pctrlBEMToolBar->addWidget(m_pctrlPowerView);
        m_pctrlBEMToolBar->addSeparator();
        m_pctrlBEMToolBar->addWidget(m_pctrlBEMWing);
        m_pctrlBEMToolBar->addWidget(m_pctrlBEMSim);
        m_pctrlBEMToolBar->addWidget(m_pctrlBEMPoint);
        m_pctrlBEMToolBar->addSeparator();
        m_pctrlBEMToolBar->addWidget(m_pctrlHideWidgets);


        m_pctrlBEM360ToolBar = addToolBar(tr("BEM"));
        m_pctrlBEM360ToolBar->addAction(newProjectAct);
        m_pctrlBEM360ToolBar->addAction(openAct);
        m_pctrlBEM360ToolBar->addAction(saveAct);
        m_pctrlBEM360ToolBar->addSeparator();
        m_pctrlBEM360ToolBar->addWidget(m_pctrlGraphView2);
        m_pctrlBEM360ToolBar->addWidget(m_pctrl3DView2);
        m_pctrlBEM360ToolBar->addWidget(m_pctrlPowerView2);
        m_pctrlBEM360ToolBar->addSeparator();
        m_pctrlBEM360ToolBar->addWidget(m_pctrlBEMFoils);
        m_pctrlBEM360ToolBar->addWidget(m_pctrlBEMPolars);
        m_pctrlBEM360ToolBar->addWidget(m_pctrlBEM360Polars);
        m_pctrlBEM360ToolBar->addSeparator();
        m_pctrlBEM360ToolBar->addWidget(m_pctrlHideWidgets2);

        m_pctrlTurbineToolBar = addToolBar(tr("Propeller"));
        m_pctrlTurbineToolBar->addAction(newProjectAct);
        m_pctrlTurbineToolBar->addAction(openAct);
        m_pctrlTurbineToolBar->addAction(saveAct);
        m_pctrlTurbineToolBar->addSeparator();
        m_pctrlTurbineToolBar->addWidget(m_pctrlGraphView3);
        m_pctrlTurbineToolBar->addWidget(m_pctrl3DView3);
        m_pctrlTurbineToolBar->addWidget(m_pctrlPowerView3);
        m_pctrlTurbineToolBar->addSeparator();
        m_pctrlTurbineToolBar->addWidget(m_pctrlTurbine);
        m_pctrlTurbineToolBar->addWidget(m_pctrlTurbineSim);
        m_pctrlTurbineToolBar->addWidget(m_pctrlTurbinePoint);
        m_pctrlTurbineToolBar->addSeparator();
        m_pctrlTurbineToolBar->addWidget(m_pctrlHideWidgets3);
        ...
        m_pctrlBEMWidget->setSizePolicy(szPolicyMinimum);
        ...
        QBEM *pBEM = (QBEM*)m_pBEM;
        connect(m_pctrlBEMWing,SIGNAL(activated(int)), pBEM, SLOT(OnSelChangeWing(int)));
        connect(m_pctrlBEMFoils,SIGNAL(activated(int)), pBEM, SLOT(OnSelChangeFoil(int)));
        connect(m_pctrlBEMPolars,SIGNAL(activated(int)), pBEM, SLOT(OnSelChangePolar(int)));
        connect(m_pctrlBEM360Polars,SIGNAL(activated(int)), pBEM, SLOT(OnSelChange360Polar(int)));
        connect(m_pctrlBEMSim,SIGNAL(activated(int)), pBEM, SLOT(OnSelChangeRotorSimulation(int)));
        connect(m_pctrlBEMPoint,SIGNAL(activated(int)), pBEM, SLOT(OnSelChangeBladeData(int)));
        connect(m_pctrlTurbine,SIGNAL(activated(int)), pBEM, SLOT(OnSelChangeTurbine(int)));
        connect(m_pctrlTurbineSim,SIGNAL(activated(int)), pBEM, SLOT(OnSelChangeTurbineSimulation(int)));
        connect(m_pctrlTurbinePoint,SIGNAL(activated(int)), pBEM, SLOT(OnSelChangeTurbineBladeData(int)));
        connect(m_pctrlHideWidgets,SIGNAL(clicked()), pBEM, SLOT(OnHideWidgets()));
        connect(m_pctrlHideWidgets2,SIGNAL(clicked()), pBEM, SLOT(OnHideWidgets()));
        connect(m_pctrlHideWidgets3,SIGNAL(clicked()), pBEM, SLOT(OnHideWidgets()));
...
void MainFrame::CreateBEMActions()
{
    ...
    ThreeDViewAct = new QAction(QIcon(":/images/blade.png"), tr("Blade View"), this);
    ThreeDViewAct->setCheckable(true);
    ThreeDViewAct->setStatusTip(tr("Show Blade View"));
    connect(ThreeDViewAct, SIGNAL(triggered()), pBEM, SLOT(OnWingView()));

    GraphViewAct = new QAction(QIcon(":/images/extra.png"), tr("360 Polars View"), this);
    GraphViewAct->setCheckable(true);
    GraphViewAct->setStatusTip(tr("Show 360 Polars View"));
    connect(GraphViewAct, SIGNAL(triggered()), pBEM, SLOT(On360View()));
    PowerViewAct = new QAction(QIcon(":/images/rotor.png"), tr("Propeller Simulation View"), this);
    PowerViewAct->setCheckable(true);
    PowerViewAct->setStatusTip(tr("Show Propeller Simulation View"));
    connect(PowerViewAct, SIGNAL(triggered()), pBEM, SLOT(OnPowerView()));

    CharViewAct = new QAction(QIcon(""), tr(""), this);
    CharViewAct->setCheckable(false);
    CharViewAct->setStatusTip(tr("Show Rotor Simulation View"));
    connect(CharViewAct, SIGNAL(triggered()), pBEM, SLOT(OnCharView()));
    ...
    CompareCurrentBladeCurveAct->setStatusTip(tr("Compares the Blade Curves of different Blades or Propellers"));
    connect(CompareCurrentBladeCurveAct, SIGNAL(triggered()), pBEM, SLOT(OnCompareIsolatedBladeCurves()));

    DeleteCurrentBladeAct = new QAction(tr("Delete Current Blade"), this);
    DeleteCurrentBladeAct->setCheckable(false);
    DeleteCurrentBladeAct->setStatusTip(tr("Deletes the currently selected Blade"));
    connect(DeleteCurrentBladeAct, SIGNAL(triggered()), pBEM, SLOT(OnDeleteWing()));
    ...
    DeleteCurrentTurbineAct = new QAction(tr("Delete Current Propeller"), this);
    DeleteCurrentTurbineAct->setCheckable(false);
    DeleteCurrentTurbineAct->setStatusTip(tr("Deletes the currently selected Propeller"));
    ...
    DeleteCurrentTurbineSimAct = new QAction(tr("Delete Current Propeller Sim"), this);
    DeleteCurrentTurbineSimAct->setCheckable(false);
    DeleteCurrentTurbineSimAct->setStatusTip(tr("Deletes the currently selected Propeller Simulation"));
    connect(DeleteCurrentTurbineSimAct, SIGNAL(triggered()), pBEM, SLOT(OnDeleteTurbineSim()));

    LoadCylindricFoilAct = new QAction(tr("Load a Cylindric Foil"), this);
    LoadCylindricFoilAct->setCheckable(false);
    LoadCylindricFoilAct->setStatusTip(tr("Loads a Cylindric Foil"));
    connect(LoadCylindricFoilAct, SIGNAL(triggered()), pBEM, SLOT(OnLoadCylindricFoil()));

    ExportBladeGeomAct = new QAction(tr("ExportBlade Geometry"), this);
    ExportBladeGeomAct->setCheckable(false);
    ExportBladeGeomAct->setStatusTip(tr("Exports the Blades Geometry"));
    connect(ExportBladeGeomAct, SIGNAL(triggered()), pBEM, SLOT(OnExportGeometry()));
    ...
    EditCurrentTurbineAct = new QAction(tr("Edit current Propeller"), this);
    ...
    LightOptionsAct = new QAction(tr("OpenGL Light Settings"), this);
    LightOptionsAct->setCheckable(false);
    LightOptionsAct->setStatusTip(tr("Change the GL Light Settings"));
    connect(LightOptionsAct, SIGNAL(triggered()), pBEM, SLOT(OnLightDlg()));

    EditCurrentBladeAct = new QAction(tr("Edit current Blade"), this);
    EditCurrentBladeAct->setCheckable(false);
...
void MainFrame::CreateBEMMenus()
{
    ...
    currentBladeMenu = BEMCtxMenu->addMenu(tr("Current Blade"));
    ...
    currentTurbineMenu = BEMCtxMenu->addMenu(tr("Current Propeller"));
    ...
    current360PolarMenu = BEMCtxMenu->addMenu(tr("Current 360° Polar"));
    current360PolarMenu->addAction(LoadCylindricFoilAct);
    ...
    BEMViewMenu->addAction(ThreeDViewAct);
    BEMViewMenu->addAction(GraphViewAct);
    BEMViewMenu->addAction(PowerViewAct);
    BEMViewMenu->addSeparator();
    BEMViewMenu->addAction(unitsAct);
    BEMViewMenu->addAction(styleAct);
    BEMBladeMenu = menuBar()->addMenu(tr("&Blade"));
    BEMBladeMenu->addAction(DeleteCurrentBladeAct);
    BEMBladeMenu->addAction(ExportBladeGeomAct);
    BEMBladeMenu->addAction(saveViewToImageFileAct);

    BEMBladeMenu->addAction(LightOptionsAct);
    ...
    BEMTurbine = menuBar()->addMenu(tr("&Propeller"));
...
void MainFrame::DeleteProject()
{
	...
	pXDirect->SetFoil();
        ...
        for (i=pBEM->s_poa360Polar->size()-1; i>=0;i--)
        {
        CPolar *pPolar = (CPolar *) pBEM->s_poa360Polar->at(i);
        pBEM->s_poa360Polar->removeAt(i);
        delete pPolar;
        }

        for (i=pBEM->s_poaBEMWings->size()-1; i>=0;i--)
        {
        CBlade *pWing = (CBlade *) pBEM->s_poaBEMWings->at(i);
        pBEM->s_poaBEMWings->removeAt(i);
        delete pWing;
        }

        for (i=pBEM->s_poaBEMData.size()-1; i>=0;i--)
        {
        delete pBEM->s_poaBEMData.at(i);
        pBEM->s_poaBEMData.removeAt(i);
        }

        for (i=pBEM->s_poaTData.size()-1; i>=0;i--)
        {
        delete pBEM->s_poaTData.at(i);
        pBEM->s_poaTData.removeAt(i);
        }

        for (i=pBEM->s_poaTBEMData.size()-1; i>=0 ;i--)
        {
        delete pBEM->s_poaTBEMData.at(i);
        pBEM->s_poaTBEMData.removeAt(i);
        }

        pBEM->m_pBData          = NULL;
        pBEM->m_pTurbineBData   = NULL;
        pBEM->m_pBEMData        = NULL;
        pBEM->m_pTData          = NULL;
        pBEM->m_pTBEMData       = NULL;
        pBEM->m_pWing           = NULL;
        pBEM->m_pFoil           = NULL;



        pBEM->m_pCur360Polar    = NULL;
        pBEM->m_pCurPolar       = NULL;
        ...
        if (m_iApp == BEM)
        {
            ...
            pBEM->CreatePolarCurve();
            pBEM->CreatePowerCurves();
            //pBEM->CreateRotorCurves();
        ...
        /////// new code DM/////
                 case 7:
                 {
                        QBEM *pBEM = (QBEM *) m_pBEM;
                         for (j=0; j<24; j++)
                         {
                                 for (i=0; i<pBEM->s_poaBEMData.size(); i++)
                                 {
                                         bFound = false;
                                         if(pBEM->s_poaBEMData.at(i)->m_Color == m_crColors[j])
                                         {
                                                 bFound = true;
                                                 break;
                                         }
                         ...
                         return m_crColors[pBEM->s_poaBEMData.size()%24];
                         break;
                 }
                 ...
                 case 8:
                 {
                        QBEM *pBEM = (QBEM *) m_pBEM;
                         for (j=0; j<24; j++)
                         {
                                 for (i=0; i<pBEM->s_poaTBEMData.size(); i++)
                                 {
                                         bFound = false;
                                         if(pBEM->s_poaTBEMData.at(i)->m_Color == m_crColors[j])
                                         {
                                                 bFound = true;
                                                 break;
                                         }
                         ...
                         return m_crColors[pBEM->s_poaTBEMData.size()%24];
                         break;
                 }
                case 9:
                {
                ...
                case 11:
                {
                       QBEM *pBEM = (QBEM *) m_pBEM;
                        for (j=0; j<24; j++)
                        {
                                for (i=0; i<pBEM->s_poa360Polar->size(); i++)
                                {
                                        bFound = false;
                                        CPolar *pPolar = (CPolar *) pBEM->s_poa360Polar->at(i);
                                        if(pPolar->m_Color == m_crColors[j])
                        ...
                        return m_crColors[pBEM->s_poa360Polar->size()%24];
                        break;
                }
            //// end new code DM///
...
void MainFrame::OnBEM()
{
        ...
        SetMenus();
        UpdateView();
        if (pBEM->m_iView == PolarView) pBEM->On360View();
...
void MainFrame::SetCentralWidget()
{
	QMiarex *pMiarex = (QMiarex*)m_pMiarex;
        ...
        if(m_iApp==BEM && pBEM->m_iView == WingView)
        {
                m_pctrlCentralWidget->setCurrentIndex(1);
        }
        else if(m_iApp == BEM && (pBEM->m_iView == PolarView || pBEM->m_iView == CharView))
        {
...
bool MainFrame::SerializeProject(QDataStream &ar, bool bIsStoring, int ProjectFormat)
{
	...
	if (bIsStoring)
	{
		// storing code
        ar << 100016;
        // 100016 : New 360Polar parameters
...
//		pAFoil->m_pPF->Serialize(ar, bIsStoring);
                ...
                CPolar *pPolar;
                ar << (int) m_PowerUnit;
                ar << (int)pBEM->s_poaBEMWings->size();
                for (i=0; i<pBEM->s_poaBEMWings->size();i++)
                {
                        pWing = (CBlade*) pBEM->s_poaBEMWings->at(i);
                        pWing->SerializeWing(ar, bIsStoring, ProjectFormat);
                }
                ar << (int)pBEM->s_poa360Polar->size();
                for (i=0; i<pBEM->s_poa360Polar->size();i++)
                {
                        pPolar = (CPolar *) pBEM->s_poa360Polar->at(i);
                        pPolar->Serialize360(ar, bIsStoring, 0);
                }
                ar << (int) pBEM->s_poaBEMData.size();
                for (i=0;i<pBEM->s_poaBEMData.size();i++)
                {
                        pBEM->s_poaBEMData.at(i)->Serialize(ar,bIsStoring);
                }
                ar << (int) pBEM->s_poaTBEMData.size();
                for (i=0;i<pBEM->s_poaTBEMData.size();i++)
                {
                        pBEM->s_poaTBEMData.at(i)->Serialize(ar,bIsStoring,0);
                }
                ar << (int) pBEM->s_poaTData.size();
                for (i=0;i<pBEM->s_poaTData.size();i++)
                {
                        pBEM->s_poaTData.at(i)->Serialize(ar,bIsStoring,0);
                }
                ////////////end new code DM/////////////
...
//			if(pWPolar->m_WPolarType==STABILITYPOLAR)	pWPolar->m_bThinSurfaces = true;
		...
		pAFoil->m_pSF->Serialize(ar, bIsStoring);
                ...
                {
                //////////////new code DM////////////////
                //Quick and dirty fix to enably compatibility with old project files, will be replaced with andrés solutions as soon as availiable
		...
		if(m_iApp==MIAREX) pMiarex->SetUFO();
                ...
                for (i=0; i < n ;i++)
                {
                        ...
                        if (pWing->SerializeWing(ar, bIsStoring, ProjectFormat))
                        {
                        pBEM->s_poaBEMWings->append(pWing);
                        }
                }
                // Then 360° Polars
                ar >> n;
                ...
                {
                        pPolar = new CPolar();
                        pPolar->Serialize360(ar, bIsStoring, ArchiveFormat);
                        pBEM->s_poa360Polar->append(pPolar);
                }
                ...
                for (i=0; i < n ; i++)
                {
                        ...
                        pBEMData->Serialize(ar, bIsStoring);
                        pBEM->s_poaBEMData.append(pBEMData);
                }
                ...
                for (i=0; i < n ; i++)
                {
                        ...
                        pBEM->s_poaTBEMData.append(pTBEMData);
                }

                // And finally the TData
                ...
                if (pBEM->s_poaBEMWings->size()) pBEM->UpdateWings();

                if (pBEM->s_poaTData.size()) pBEM->UpdateTurbines();

                if (pBEM->s_poaFoil->size()) pBEM->UpdateFoils();
