...
void GraphDlg::FillVariableList()
{
	...
	else if(m_iGraphType == 64)
	{
        ...
        else if(m_iGraphType == 70)
        {
                ...
                m_pctrlYSel->addItem(tr("Cp Betz"));            //13
                /////////new code JM/////////
                m_pctrlYSel->addItem(tr("Propeller Cp"));
                m_pctrlYSel->addItem(tr("Ct"));
                m_pctrlYSel->addItem(tr("Propeller Ct"));
                /////////end new code JM/////////
                m_pctrlYSel->addItem(tr("Kp"));
                m_pctrlYSel->addItem(tr("Advace Ratio (v/(n.D)"));
                m_pctrlYSel->addItem(tr("Propeller efficiency"));


                m_pctrlXSel->addItem(tr("Tip Speed Ratio"));
                m_pctrlXSel->addItem(tr("1 / Tip Speed Ratio"));//12
                m_pctrlXSel->addItem(tr("Cp Betz"));            //13
             /////////new code JM/////////
                m_pctrlXSel->addItem(tr("Propeller Cp"));
                m_pctrlXSel->addItem(tr("Ct"));
                m_pctrlXSel->addItem(tr("Propeller Ct"));
                /////////end new code JM/////////
                m_pctrlXSel->addItem(tr("Kp"));
                m_pctrlXSel->addItem(tr("Advace Ratio (v/(n.D)"));
                m_pctrlXSel->addItem(tr("Propeller efficiency"));
        ...
        else if(m_iGraphType == 80)
        {
                ...
                m_pctrlYSel->addItem(tr("Tip Speed Ratio"));
                m_pctrlYSel->addItem(tr("Omega"));					//14
                m_pctrlYSel->addItem(tr("Cp"));						//15
                m_pctrlYSel->addItem(tr("Propeller Cp"));
                m_pctrlYSel->addItem(tr("Ct"));                     //16
                m_pctrlYSel->addItem(tr("Propeller Ct"));
                m_pctrlYSel->addItem(tr("Pitch"));
                ...
                m_pctrlXSel->addItem(tr("Tip Speed Ratio"));
                m_pctrlXSel->addItem(tr("Omega"));					//14
                m_pctrlXSel->addItem(tr("Cp"));						//15
                m_pctrlXSel->addItem(tr("Propeller Cp"));
                m_pctrlXSel->addItem(tr("Ct"));                     //16
                m_pctrlXSel->addItem(tr("Propeller Ct"));
                m_pctrlXSel->addItem(tr("Pitch"));
